...
import { canCancelAppointment, canRescheduleAppointment, hasAppointmentConflict } from './appointment-rules.js';
...
describe('appointment rules', () => {
  ...
  it('detects overlapping appointments on the same date', () => {
    const overlapping = { ...appointment, id: 'appointment-2', startTime: '10:30', endTime: '11:30' };
