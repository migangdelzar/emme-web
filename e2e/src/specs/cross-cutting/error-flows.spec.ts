...
test.describe('Error Flows - Unauthenticated', { tag: [Tag.AUTH, Tag.REGRESSION, Tag.ERROR_STATE] }, () => {
  test('all protected sections redirect to landing when unauthenticated', async ({ unauthenticatedPage }) => {
